...
// Updated for PayPal redirect modal, auto‑fill email for logged‑in users

// ========== PRODUCT DATA (20 products, prices $12.99 – $32.99) ==========
...
openPaymentRedirectModal(); // open new redirect modal
cleanup();
};
